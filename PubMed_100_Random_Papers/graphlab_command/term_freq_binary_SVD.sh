...
# target matrix: 
TARGET=/projects/slin_prj/PubMed_Experiment/matrices/term_freq_binary.matrix
...
OUT_DIR=/projects/slin_prj/PubMed_Experiment/GraphLab_SVD_results/term_freq_binary
#mkdir -p $OUT_DIR
